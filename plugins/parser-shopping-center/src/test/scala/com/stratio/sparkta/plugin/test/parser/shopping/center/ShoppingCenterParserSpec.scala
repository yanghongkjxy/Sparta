...
class ShoppingCenterParserSpec extends WordSpecLike {
  ...
  "A ShoppingCenterParser" should {
    ...
    "parse a line order" in {
      ...
      assertResult(true)(result.keyMap.contains("eventDatetime"))
